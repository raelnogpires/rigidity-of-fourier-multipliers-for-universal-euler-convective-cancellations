...
which resolves to the most recent version and lists the version DOI of each
individual snapshot; cite the version DOI to pin an exact snapshot. The
archived materials are distributed under the Creative Commons Attribution 4.0
