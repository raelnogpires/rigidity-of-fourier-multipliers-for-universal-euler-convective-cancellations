...
manifest and the Lean formalization accompany this paper in the repository
release. The verification entry point and software versions are recorded in
the accompanying reproduction documentation; the release identifier should
be retained when the materials are archived or cited.
